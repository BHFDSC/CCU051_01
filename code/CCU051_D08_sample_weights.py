...
# MAGIC FROM .ccu051_tmp_population_estimates_age_sex
...
# MAGIC %sql
# MAGIC SELECT sum(pe_census2021) as sum_pe_census2021_region, sum(cohort) as sum_cohort FROM .ccu051_tmp_population_estimates_age_sex_region
